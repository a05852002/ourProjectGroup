...
@WebServlet("/Servlet/searchAllTeacServlet")
public class searchAllTeacServlet extends HttpServlet {
private static final long serialVersionUID = 1L;
 
 private static Logger log = LoggerFactory.getLogger(searchAllTeacServlet.class);
 ...
 protected void doPost(HttpServletRequest request, HttpServletResponse response)
  ...
  teacAndStudDao classService = new teacAndStudDao(); 
	try {
		List<tableForTeac> classlist = classService.searchAllTeac();
