...
public class DBService {
	...
	private static final String DBURL_SQLServer = "jdbc:sqlserver://" + host + ":1433;databaseName=MeetBoth";
	...
	private static final String DROP_VITAE_SQLServer = 
			"IF OBJECT_ID('dbo.Vitae', 'U') IS NOT NULL "
					+ " DROP TABLE dbo.Vitae; ";;
	...
	private static final String CREATE_Member_SQLServer = " CREATE TABLE Member " 
			...
			+ " IDNUMBER			varchar(32), " 
			+ " MEMNAME 			nvarchar(20), "
			+ " MEMNICKNAME			nvarchar(20), " 
			+ " MEMOLD 				INT, "
			+ " MEMBIRTH			Date, " 
			+ " MEMGENDER    		NVARCHAR(4), "
			+ " EMAIL     			VARCHAR(80), " 
			+ " PHONE 				INT, "
			+ " ADDRESS     		nvarchar(50), " 
			+ " PHOTO				Image, "
			...
			+ " )";
	private static final String CREATE_VITAE_SQLSERVER ="CREATE TABLE Vitae"
			+ "(VITAE				INT not null identity,"
			+ " SelfIntro			NVARCHAR(500),"
			+ " ACADEMIC			NVARCHAR(20),"
			+ " EXPE				NVARCHAR(100),"
			+ " SENIORITY			INT,"
			+ " SKILL				NVARCHAR(40),"
			+ " CLASSTIME			NVARCHAR(40),"
			+ " EXPECTED			MONEY,"
			+ " PRIMARY KEY 		(VITAE)"
			+ " )";
	...
	public static String getCreateVitae() {
		return CREATE_VITAE_SQLSERVER;
	}

	public static String getDropVitae() {
		return DROP_VITAE_SQLServer;
	}
