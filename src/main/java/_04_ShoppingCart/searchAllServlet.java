...
@WebServlet("/_04_ShoppingCart/searchAllServlet")
public class searchAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Logger log = LoggerFactory.getLogger(searchAllServlet.class);
	int pageNo = 1;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		OrdersDao classService = new OrdersDao(); 
			try {
				List<OrderBean> classlist = classService.searchAllorders();
