...
<!-- 					</section> -->
					...
					<div class="table-wrapper">
						<div id='main'>
							<form
								action="<c:url value='/_04_ShoppingCart/OrderInsert.do'/>"
								method="post">
								<label>會員編號</label>
								<input type="text" name="memberId" value="${bean.memberId}" placeholder="請填寫會員編號" required>
								<label>地址</label> <input
									type="text" name="shippingAddress" value="${bean.shippingAddress}" placeholder="請填寫收件地址" required>
