							...
							<c:forEach var="bean" items="${OrdersItemDao}">
								<form method="post"
									...
									<input type="text" name="productId" value="${productId}"
										...
										placeholder="請填寫產品名稱" required> <label>產品描述:</label> <input
										type="text" name="description" value="${description}"
										placeholder="請填寫產品描述" required> <label>數量:</label> <input
										type="number" name="qty" value="${qty}"
										placeholder="請輸入數量" required> <label>單價:</label> <input
										type="number" name="unitPrice" value="${unitPrice}"
										placeholder="請填寫金額單價" required> <label>總金額</label> <input
										type="text" name="totalAmount" value="0" readonly>
