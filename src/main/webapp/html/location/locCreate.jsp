			...
			<div class="inner">
				...
				<section>
					...
					<div class="table-wrapper">
						<div id='main'>
							<form action="<c:url value='/locServlet/locationCreateServlet'/>"
								method='post'>

								<label>地點編號</label> <input type="text" name="locno"
									value="${bean.locno}" placeholder="請填寫科目編號" required> <label>地點名稱</label>
								<input type="text" name="locname" value="${bean.locname}"
									placeholder="請填寫科目名稱" required> <label>地點分類</label> <input
