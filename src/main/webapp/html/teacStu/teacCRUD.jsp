...
String basePathimg=request.getScheme() + "://"+request.getServerName()+":"+request.getServerPort()+pathimg+"/html/images/meatball-icon.png";
%>
<%
String basePathimg2=request.getScheme() + "://"+request.getServerName()+":"+request.getServerPort()+path+"/html/images/meatball-200.png";
%>
<%
String updateteac=request.getScheme() + "://"+request.getServerName()+":"+request.getServerPort()+path+"/html/updateteac.jsp";
%>
...
<body class="is-preload">
	...
	<div id="wrapper">
	   ...
	   <!-- Header -->
				<header id="header">
					<h1 class="logo"><strong>管理者介面</strong></h1>
				</header>
				...
				<section>
					<header class="main">
						...
						<input type="button" value="新增" onclick="location.href='http://localhost:8080/jspTeam5/html/insertpage.jsp'">
					</header>
						<form method="post" action="<c:url value='/Servlet/searchLike' />">
							<input type="text" name="search" id="search" placeholder="Search" style="width:80%" />
						</form>
						<br>
						<div>
						<form method="post" action="<c:url value='/Servlet/switchsequence' />">
						<h3>請選擇排列方式</h3>
						...
						<div>
						<form method="post" action="<c:url value='/Servlet/searchallbyprice' />">
									...
									<tbody>
										<tr>
											<td>${bean.teacno}</td>
     										...
     										<td><img height='100' width='80'src="<c:url value='/Servlet/picsave?id=${bean.teacno}' />"></td>
     										<td><input type="button" value="修改" onclick="location.href='http://localhost:8080/jspTeam5/Servlet/datesave?teacno=${bean.teacno}'"></td>
<%--      										<td><input type="button" value="刪除"  onclick="location.href='http://localhost:8080/jspTeam5/Servlet/deletedata?teacno=${bean.teacno}'"></td> --%>
     										<td><form method="post" action="<c:url value='/Servlet/deletedata'/>"> <button name="teacno" value="${bean.teacno}">刪除</button></form></td>
										</tr>
									</tbody>
									</c:forEach>
									</table>
