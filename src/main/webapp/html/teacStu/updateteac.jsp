							...
							<form action='<c:url value="/Servlet/updatedata" />' enctype='multipart/form-data' method='post'>
								...
								<c:forEach var="bean" items="${bean}">
									<thead>
										...
										<tr><td><input name="memberId" type="text" value="${bean.memberId}" style="width:80%"></td></tr>
										...
										<tr><td><input name="price" type="text" value="${bean.price}" style="width:80%"></td></tr>
										...
										<br>
										<img id="preImg" style="width:150px; height:200px" src="<c:url value='/Servlet/picsave?id=${bean.teacno}' />" />
										</td></tr>
									</thead>
								</c:forEach>
									</table>
