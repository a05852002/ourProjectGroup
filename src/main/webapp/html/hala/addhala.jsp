			...
			<div class="inner">
				...
				<section>
					<header class="main">
						<h1>新增貼文</h1>
						<div>
						<form  action="<c:url value='/halaservlet/addservlet'/>" method="post">							
							<label>分類名稱</label> 
							...
							<label>會員編號</label> 
							<input type="text" name="memberid" value="${bean.memberId}"onkeyup="value=value.replace(/[^\d]/g,'') "> 
							<label>標題</label> 
							<input type="text" name="title" value="${bean.title}"> 
							<label>內容</label> 
							<textarea rows="70" cols="30" name="halacontent" value="${bean.halacontent}" ></textarea>
